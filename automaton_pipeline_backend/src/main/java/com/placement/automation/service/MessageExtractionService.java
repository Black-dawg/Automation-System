    ...
    public JobOpportunity extractJobOpportunity(String rawMessage) {
        return this.chatClient.prompt()
                .system("""
                        ...
                        - 'deadline': Format all deadlines strictly as 'DD Month YYYY, HH:MM AM/PM' (e.g., '23rd July 2026, 11:00 AM'). Always place the day before the month and do not include seconds in the time. If the year is not explicitly mentioned in the message, default to the year 2026.
